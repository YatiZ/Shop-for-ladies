    ...
    <footer className=" mt-14 bg-yellow-200 py-6 text-center border-t-red-600 border">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-1">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d201807.51023125357!2d-122.67682531328121!3d37.784359900000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808580770df6174d%3A0x8be3ee157d693ab2!2sDelancey%20Street%20Restaurant!5e0!3m2!1sen!2smm!4v1698056414989!5m2!1sen!2smm" className='w-80 h-64 border-none' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className="ml-4 mt-2"></iframe>
        </div>
        <div className="lg:col-span-1">
